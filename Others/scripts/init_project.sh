...
prompt AI_EXPLAINER_MODEL "AI explainer model" "gpt-5.1"
prompt AI_PARSER_MODEL "AI parser model" "gpt-5.1"
prompt AI_PDF_NORMALIZE_MODEL "AI PDF normalize model" "gpt-5.1"
